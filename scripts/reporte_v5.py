"""Generate T-4 v5 report: classifier results with directive FASE 2 prompt."""
...
REPORT_PATH = PROJECT_ROOT / "reports" / "testing" / "04-classifier-v5.html"
...
Cada gap tiene su propia pregunta ("¿La oferta pide...?", "¿Requiere experiencia en...?"),
más la regla explícita "Si hay algún gap, gap_types NO puede ser []".
</div>
...
function toggleCard(id) {{
  ...
  if (b.style.display === 'block') {{
    ...
    print(f"Reporte v5 generado: {REPORT_PATH}")
