...
REPORT_PATH = PROJECT_ROOT / "reports" / "testing" / "04-classifier-v4.html"
...
&middot; <a href="04-classifier.html">v1 original</a> &middot; <a href="04-classifier-v2.html">v2</a> &middot; <a href="04-classifier-v3.html">v3</a> &middot; <b>v4</b> &middot; <a href="04-classifier-v5.html">v5</a> &middot; <a href="04-classifier-v6.html">v6</a></p>

<div class="note">
<strong>Cambios en v4:</strong> Prompt refactorizado a <code>_build_prompt()</code> con FASE 1 (rol) y FASE 2
(fit) visualmente separadas, gap types semánticos sin hardcodeo de seniority,
<code>FORBIDDEN_IN_ROLE_REASONING</code> expandido, y heurística en
<code>resolve_gap_type()</code> que corrige inflación de seniority cuando coexiste solo
con herramienta.
</div>
...
function toggleCard(id) {{
  ...
  if (b.style.display === 'block') {{
    ...
    print(f"Reporte v4 generado: {REPORT_PATH}")
