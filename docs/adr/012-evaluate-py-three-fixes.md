...
- **F_exp now reflects real experience.** For this candidate, all offers get `F_exp = years_match`. *(Note: gap was later moved to qualitative HR context — see ADR-013. The `gap_multiplier` no longer multiplies F_exp.)*
